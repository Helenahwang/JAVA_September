...
<body>
	...
	보낼내용<input type="text" id="message" size="50" />
	<input type = "button" id="send" value="보내기" /><br/>
	받은내용<textarea id="print" cols="80" rows="15"></textarea><br/>
...
<script>
	document.getElementById("proxy").addEventListener("click",function(){
		$.ajax({
			...
			success:function(data){
				...
				//index는 순회하는 배열의 인덱스이고 item은 데이터이다.
	...
	var websocket = new WebSocket("ws://localhost:8080/0911class/websocket")
